...
function ProblemSet() {
  ...
  (Array.isArray(problem.tags)
    ? problem.tags.some(tag => tag.toLowerCase() === filters.tag.toLowerCase())
      ...
      <nav className="bg-slate-800/70 backdrop-blur-sm border-b border-slate-700/50 shadow-lg shadow-black/30 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <NavLink to="/" className="text-2xl font-bold text-white hover:text-blue-400 transition-colors duration-200">
              AlgoForge
            </NavLink>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="dropdown dropdown-end">
              <div tabIndex={0} className="flex items-center gap-2 cursor-pointer text-slate-300 hover:text-white transition-colors duration-200">
        ...
        <div className="grid gap-4">
          {filteredProblems.length === 0 ? (
            <div className="text-center py-12">
              <div className="text-slate-400 text-lg">No problems found matching your filters.</div>
              <button 
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-4">
                        <h2 className="text-xl font-bold text-white hover:text-blue-400 transition-colors duration-200">
                          <NavLink to={`/problem/${problem._id}`} className="hover:text-blue-400">
                            {problem.title}
                          </NavLink>
                        </h2>
                        {isSolved && (
                      ...
                      <div className={`px-3 py-1 border rounded-full text-sm font-medium ${getDifficultyColor(problem.difficulty)}`}>
                        {problem.difficulty}
                      </div>
                    </div>
